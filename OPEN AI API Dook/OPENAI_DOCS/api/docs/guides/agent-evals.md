...
fetched_at: 2026-07-27T01:57:40Z
---
...
For code-first SDK workflows, start with [Integrations and observability](agents/integrations-observability.md) to get high-signal traces before you formalize graders.
...
If you need advanced features such as evaluation against external models, evaluation APIs, or larger-scale batch evaluation, use [Evals](evals.md) alongside datasets.

## Related evaluation surfaces

[Getting started with evals: Datasets

Operate a flywheel of continuous improvement using evaluations.](evaluation-getting-started.md)
[Working with evals
