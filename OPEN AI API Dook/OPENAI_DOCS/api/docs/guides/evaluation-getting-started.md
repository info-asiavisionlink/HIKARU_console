...
fetched_at: 2026-07-27T01:55:37Z
---
...
larger scale, consider using [Evals](evals.md) instead.
...
1. To add a new prompt, click **Add prompt**.
   ...
   Datasets are designed to be used with your OpenAI [prompts](prompt-engineering.md). If you’ve saved a prompt on the OpenAI platform, you’ll be able to select it from the dropdown and make changes in this interface. To save your prompt changes, click **Save**.
...
- Click the slider icon in the top right to control model [`temperature`](../api-reference/responses/create.md) and [`top_p`](../api-reference/responses/create.md).
...
If you’re not an expert on the contents of your dataset, have a subject matter expert perform the annotation. This is the best way to incorporate expertise into the optimization process. Explore [our cookbook](/cookbook/examples/evaluation/building_resilient_prompts_using_an_evaluation_flywheel) to learn more.
...
Learn more about our [graders](graders.md).

## Next steps

Datasets are great for rapid iteration. When you’re ready to track performance over time or run at scale, export your dataset to an [Eval](evals.md). Evals run asynchronously, support larger data volumes, and let you monitor performance across versions.

For more inspiration, visit the [OpenAI Cookbook](/cookbook/topic/evals), which contains example code and links to third-party resources, or learn more about our evaluation tools:
...
Use your dataset to automatically improve your prompts.](prompt-optimizer.md)
[Graders
