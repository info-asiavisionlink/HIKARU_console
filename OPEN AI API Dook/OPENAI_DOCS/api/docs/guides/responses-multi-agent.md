...
fetched_at: 2026-07-27T01:55:16Z
---
...
![HTTP function call execution across the application, Responses API root, and three subagents.](../../../assets/images_api_multi-agent_multi-agent-1.png)

#### WebSocket function call execution

![WebSocket function call execution across the application, Responses API root, and three subagents.](../../../assets/images_api_multi-agent_multi-agent-2.png)
...
- [WebSocket mode](websocket-mode.md)
