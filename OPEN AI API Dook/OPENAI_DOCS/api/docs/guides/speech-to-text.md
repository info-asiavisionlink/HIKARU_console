---
source_url: https://developers.openai.com/api/docs/guides/speech-to-text
fetched_at: 2026-07-27T01:58:11Z
---
...
stream, use [Realtime transcription](realtime-transcription.md)
instead.
...
The [API Reference](../api-reference/audio.md) includes the full list of available parameters.
...
By default, the Transcriptions API will output a transcript of the provided audio in text. The [`timestamp_granularities[]` parameter](../api-reference/audio/createTranscription.md) enables a more structured and timestamped JSON output format, with timestamps at the segment, word level, or both. This enables word-level precision for transcripts and video edits, which allows for the removal of specific frames tied to individual words.
...
You can use a [prompt](../api-reference/audio/createTranscription.md) to improve the quality of the transcripts generated by the Transcriptions API.
...
For live audio from a microphone, call, or media stream, use the [Realtime transcription](realtime-transcription.md) guide instead of the file-oriented streaming path above. It covers the current transcription-session flow and the recommended realtime path with [`gpt-realtime-whisper`](../models/gpt-realtime-whisper.md).
