...
fetched_at: 2026-07-27T01:58:04Z
---
...
Build a coding agent with GPT-5.1 and the apply\_patch tool](/cookbook/examples/build_a_coding_agent_with_gpt-5.1)
...
Alternatively, you can use the [Agents SDK](tools.md) to use the apply patch tool. You’ll still have to implement the harness that handles the actual file operations but you can use the `applyDiff` function to handle the diff processing.
...
| --- | --- |
| [Responses](../api-reference/responses.md)  [Chat Completions](../api-reference/chat.md)  [Assistants](../api-reference/assistants.md) | [GPT-5.5](../models/gpt-5.md) [GPT-5.4](../models/gpt-5.md) [GPT-5.2](../models/gpt-5.md) [GPT-5.1](../models/gpt-5.md) |