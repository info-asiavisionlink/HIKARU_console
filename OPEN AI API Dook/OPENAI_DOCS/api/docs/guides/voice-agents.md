...
fetched_at: 2026-07-27T01:57:27Z
---
...
Voice workflows are an SDK-first surface. If you’re migrating a related Agent Builder project, see [Migrate from Agent Builder](agent-builder/migrate-from-agent-builder.md) for the current transition path.
...
- [Realtime and audio overview](realtime.md)
- [Live audio API with WebRTC](realtime-webrtc.md)
- [Live audio API with WebSocket](realtime-websocket.md)
...
- Use [Using tools](tools.md) when the voice agent needs external capabilities.
- Use [Running agents](agents/running-agents.md) when spoken workflows need streaming, continuation, or durable state.
- Use [Orchestration and handoffs](agents/orchestration.md) when spoken workflows branch across specialists.
- Use [Guardrails and human review](agents/guardrails-approvals.md) when spoken workflows need safety checks or approvals.
- Use [Integrations and observability](agents/integrations-observability.md) when you need MCP-backed capabilities or want to inspect how the voice workflow behaved.
...
Choose the right realtime or audio guide for your use case.](realtime.md)
[Managing conversations

Work with the Realtime session lifecycle and event model.](realtime-conversations.md)
[WebRTC connection

Connect browser and mobile audio directly to a Realtime session.](realtime-webrtc.md)
[Realtime prompting guide

Tune reasoning, preambles, tools, entity capture, and voice behavior.](realtime-models-prompting.md)