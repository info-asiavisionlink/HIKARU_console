---
source_url: https://developers.openai.com/api/docs/guides/webhooks
fetched_at: 2026-07-27T01:55:17Z
---
...
To see a webhook like this one in action, you can set up a webhook endpoint in the OpenAI dashboard subscribed to `response.completed`, and then make an API request to [generate a response in background mode](background.md).
...
![webhook endpoint edit dialog](../../../assets/API_images_webhook_config.png)
