...
fetched_at: 2026-07-27T01:58:08Z
---
...
| --- | --- | --- |
| [`gpt-realtime-2`](../models/gpt-realtime-2.md) | You need the strongest realtime reasoning, tool use, and instruction following. | Tune reasoning effort, preambles, tool policies, exact entity capture, and long-session state. |
| [`gpt-realtime-1.5`](../models/gpt-realtime-1.md) | You need a fast, reliable non-reasoning speech-to-speech model. | Follow the core realtime prompt structure and test for latency-sensitive behavior. |
...
![Preamble generation and playback timeline](../../../assets/images_platform_guides_realtime-2-preambles.png)
...
![lang constraint en](../../../assets/cookbook_assets_images_lang_constraint_en.png)
...
![multi language](../../../assets/cookbook_assets_images_multi-language.png)
...
![repeat before](../../../assets/cookbook_assets_images_repeat_before.png)

These are the responses **after** applying the instruction using `gpt-realtime-1.5`.

![repeat after](../../../assets/cookbook_assets_images_repeat_after.png)
...
Perhaps unsurprisingly, we recommend prompting patterns that are similar to [GPT-4.1 for best results](/cookbook/examples/gpt4-1_prompting_guide).
...
![tool proactive](../../../assets/cookbook_assets_images_tool_proactive.png)
...
![tool no confirm](../../../assets/cookbook_assets_images_tool_no_confirm.png)
...
- recognizing what the “authoritative” content is (response\_text)
- understanding the realization constraint (require\_repeat\_verbatim)
...
![escalate 06](../../../assets/cookbook_assets_images_escalate_06.png)

The second example shows conversation responses from `gpt-realtime-1.5` using the instruction.

![escalate 07](../../../assets/cookbook_assets_images_escalate_07.png)

`gpt-realtime-1.5` is able to follow the instruction and escalate to a human more reliably.

## Next steps

- Review the earlier [Realtime prompting guide](/cookbook/examples/realtime_prompting_guide) for more `gpt-realtime-1.5` examples.
- Review the [Realtime eval guide](/cookbook/examples/realtime_eval_guide) to test representative voice-agent behavior.
- Learn how to connect with [WebRTC](realtime-webrtc.md), [WebSocket](realtime-websocket.md), or [SIP](realtime-sip.md).
- Learn the [Realtime conversation lifecycle](realtime-conversations.md).
- Review [Realtime costs](realtime-costs.md).