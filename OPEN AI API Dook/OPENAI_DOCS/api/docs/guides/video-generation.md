---
source_url: https://developers.openai.com/api/docs/guides/video-generation
fetched_at: 2026-07-27T01:57:00Z
---
...
[![](../../../assets/API_docs_video-gallery_posters_Space-Race.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_maui.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_Upside-Down-City.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_fox-walk.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_zebra-chase.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_mushroom-network.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_90s-TV-Ad.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_chameleon.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_cozy-coffee-shop-interior.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_coloring.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_Sleeping-Otters.jpg)](#)[![](../../../assets/API_docs_video-gallery_posters_indie-cafe-rainy-window.jpg)](#)

The Sora 2 video generation models and Videos API are deprecated and will shut down on September 24, 2026. This affects Videos API, `sora-2`, `sora-2-pro`, `sora-2-2025-10-06`, `sora-2-2025-12-08`, and `sora-2-pro-2025-10-06`. See the [deprecations page](../deprecations.md) for details.
...
The [Videos API](/api/reference/resources/videos) exposes these capabilities to developers for the first time, enabling programmatic creation, extension, editing, and management of videos.
...
- Submit large offline render queues through the [Batch API](batch.md).
...
This level of specificity helps the model produce consistent results without inventing unwanted details. For more advanced prompting techniques, please refer to our dedicated Sora 2 [prompting guide](/cookbook/examples/sora/sora2_prompting_guide).
...
Instead of polling job status repeatedly with `GET`, register a [webhook](webhooks.md) to be notified automatically when a video generation completes or fails.
...
| Input image generated with [OpenAI GPT Image](image-generation.md) | Generated video using Sora 2 (converted to GIF) |
| --- | --- |
...
Use the [Batch API](batch.md) when you need to queue many video renders for offline processing, review pipelines, or studio workflows. Each line in the batch input file uses the same JSON request body you would send to `POST /v1/videos`, which makes it a good fit for shot lists and scheduled render queues.
