---
source_url: https://developers.openai.com/api/docs/guides/realtime-sip
fetched_at: 2026-07-27T01:58:15Z
---
...
Start by creating a [webhook](webhooks.md) for incoming calls, through your **platform.openai.com** [settings](https://platform.openai.com/settings) > Project > **Webhooks**.
...
[`realtime.call.incoming`](../api-reference/webhook-events/realtime/call/incoming.md) event,
...
Use the [Accept call endpoint](../api-reference/realtime-calls/accept-call.md) to
...
[`create client secret`](../api-reference/realtime-sessions/create-realtime-client-secret.md)
...
[`realtime.call.incoming`](../api-reference/webhook-events/realtime/call/incoming.md)
...
Use the [Reject call endpoint](../api-reference/realtime-calls/reject-call.md) to
...
[`response.create`](../api-reference/realtime_client_events/response/create.md),
and other client events to control the call, and listen for server events to
track progress. See [Webhooks and server-side controls](realtime-server-controls.md)
...
[Refer call endpoint](../api-reference/realtime-calls/refer-call.md). Provide the
...
End the session with the [Hang up endpoint](../api-reference/realtime-calls/hangup-call.md)
...
- [Realtime prompting guide](realtime-models-prompting.md)
- [Managing conversations](realtime-conversations.md)
- [Webhooks and server-side controls](realtime-server-controls.md)
- [Managing costs](realtime-costs.md)
