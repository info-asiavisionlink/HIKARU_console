...
fetched_at: 2026-07-27T01:57:29Z
---
...
Visit our [pricing page](https://openai.com/api/pricing/) to learn about embeddings pricing. Requests are billed based on the number of [tokens](https://platform.openai.com/tokenizer) in the [input](../api-reference/embeddings/create.md).

## How to get embeddings

To get an embedding, send your text string to the [embeddings API endpoint](../api-reference/embeddings.md) along with the embedding model name (e.g., `text-embedding-3-small`):
...
[Question\_answering\_using\_embeddings.ipynb](/cookbook/examples/question_answering_using_embeddings)
...
[Semantic\_text\_search\_using\_embeddings.ipynb](/cookbook/examples/semantic_text_search_using_embeddings)
...
[Code\_search.ipynb](/cookbook/examples/code_search_using_embeddings)
...
[Recommendation\_using\_embeddings.ipynb](/cookbook/examples/recommendation_using_embeddings)
...
[Visualizing\_embeddings\_in\_2D.ipynb](/cookbook/examples/visualizing_embeddings_in_2d)
...
![Amazon ratings visualized in language using t-SNE](../../../assets/API_docs_images_embeddings-tsne.png)
...
[Regression\_using\_embeddings.ipynb](/cookbook/examples/regression_using_embeddings)
...
[Classification\_using\_embeddings.ipynb](/cookbook/examples/classification_using_embeddings)
...
[Zero-shot\_classification\_with\_embeddings.ipynb](/cookbook/examples/zero-shot_classification_with_embeddings)
...
[User\_and\_product\_embeddings.ipynb](/cookbook/examples/user_and_product_embeddings)
...
![Boxplot grouped by Score](../../../assets/API_docs_images_embeddings-boxplot.png)
...
[Clustering.ipynb](/cookbook/examples/clustering)
...
![Clusters identified visualized in language 2d using t-SNE](../../../assets/API_docs_images_embeddings-cluster.png)
...
More details and example code are in the OpenAI Cookbook guide [how to count tokens with tiktoken](/cookbook/examples/how_to_count_tokens_with_tiktoken).

### How can I retrieve K nearest embedding vectors quickly?

For searching over many vectors quickly, we recommend using a vector database. You can find examples of working with vector databases and the OpenAI API [in our Cookbook](/cookbook/examples/vector_databases/readme) on GitHub.
