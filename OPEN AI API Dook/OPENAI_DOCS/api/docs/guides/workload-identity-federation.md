---
source_url: https://developers.openai.com/api/docs/guides/workload-identity-federation
fetched_at: 2026-07-27T01:58:46Z
---
...
For token exchange request and response details, authorization behavior, and current limitations, see the [workload identity token exchange reference](/api/reference/workload-identity-federation).
...
Use projected service account tokens in self-managed clusters.](workload-identity-federation/kubernetes.md)[AWS

Use outbound identity federation or Amazon EKS projected tokens.](workload-identity-federation/aws.md)[Microsoft Azure

Use managed identity tokens or AKS projected service account tokens.](workload-identity-federation/microsoft-azure.md)[Google Cloud

Use metadata server identity tokens or GKE projected service account tokens.](workload-identity-federation/google-cloud.md)[GitHub Actions

Use OIDC tokens in continuous integration workflows.](workload-identity-federation/github-actions.md)[SPIFFE

Use SPIFFE JWT-SVIDs issued by SPIRE or a compatible provider.](workload-identity-federation/spiffe.md)
