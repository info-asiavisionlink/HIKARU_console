...
fetched_at: 2026-07-27T01:55:28Z
---
...
[Open Agent Builder](https://platform.openai.com/agent-builder)
...
3. Deploy your workflow. Pass the ID into your [ChatKit](chatkit.md) integration, or download the Agents SDK code to deploy your workflow yourself.
...
![prompts chat](../../../assets/API_docs_images_homework-helper2.png)

### Available nodes

Nodes are the building blocks for agents. To see all available nodes and their configuration options, see the [node reference documentation](node-reference.md).
...
Building agent workflows comes with risks, like prompt injection and data leakage. See [safety in building agents](agent-builder-safety.md) to learn about and help mitigate the risks of agent workflows.

### Evaluate your workflow

Run [trace graders](trace-grading.md) inside of Agent Builder. In the top navigation, click **Evaluate**. Here, you can select a trace (or set of traces) and run custom graders to assess overall workflow performance.

## Publish your workflow

Agent Builder autosaves your work as you go. When you’re happy with your workflow, publish it to create a new major version that acts as a snapshot. You can then use your workflow in [ChatKit](chatkit.md), an OpenAI framework for embedding chat experiences.
...
**ChatKit**: Follow the [ChatKit quickstart](chatkit.md) and pass in your workflow ID to embed this workflow into your application. If you’re not sure, we recommend this option.
...
- [ChatKit quickstart](chatkit.md) →
- [Advanced integration](custom-chatkit.md) →