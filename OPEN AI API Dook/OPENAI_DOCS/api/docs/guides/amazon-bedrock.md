---
source_url: https://developers.openai.com/api/docs/guides/amazon-bedrock
...
See [API pricing](../pricing.md) for direct OpenAI API pricing. For Bedrock
...
- For setup in ChatGPT Work and Codex, see
  [Use ChatGPT Work and Codex with Amazon Bedrock](/codex/amazon-bedrock).