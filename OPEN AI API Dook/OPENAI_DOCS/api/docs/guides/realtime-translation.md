---
source_url: https://developers.openai.com/api/docs/guides/realtime-translation
fetched_at: 2026-07-27T01:58:07Z
---
...
Use [`gpt-realtime-translate`](../models/gpt-realtime-translate.md) when your application should translate what a human says. If you need an assistant that answers questions, calls tools, and manages a conversation, use [`gpt-realtime-2.1`](../models/gpt-realtime-2.md) with a standard Realtime session instead.
...
Connect browser media to a realtime session.](realtime-webrtc.md)
[WebSocket connection

Stream raw audio through a server-side media pipeline.](realtime-websocket.md)
[Realtime transcription

Stream transcript deltas from live audio.](realtime-transcription.md)