...
fetched_at: 2026-07-27T01:58:23Z
---
...
- using a longer, [more detailed prompt](prompt-engineering.md),
- adding (more) [few-shot examples](prompt-engineering.md), or
- [fine-tuning](model-optimization.md) / distillation.

You can also employ inference optimizations like our [**Predicted outputs**](predicted-outputs.md) feature. Predicted outputs let you significantly reduce latency of a generation when you know most of the output ahead of time, such as code editing tasks. By giving the model a prediction, the LLM can focus more on the actual changes, and less on the content that will remain the same.
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-0.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-2.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-3.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-4.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-5.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-6.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-6b.png)

#### Part 3: Optimizing the structured output

Let’s take another look at the reasoning prompt.

![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-7b.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-8b.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_token-counts-latency-customer-service-large.png)
...
![Assistants object architecture diagram](../../../assets/API_docs_images_diagram-latency-customer-service-11b.png)
