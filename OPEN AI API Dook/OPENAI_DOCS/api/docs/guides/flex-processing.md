...
fetched_at: 2026-07-27T01:58:39Z
---
...
Flex processing provides lower costs for [Responses](../api-reference/responses.md) or [Chat Completions](../api-reference/chat.md) requests in exchange for slower response times and occasional resource unavailability. It’s ideal for non-production or lower priority tasks, such as model evaluations, data enrichment, and asynchronous workloads.

Tokens are [priced](../pricing.md) at [Batch API rates](batch.md), with additional discounts from [prompt caching](prompt-caching.md).

Flex processing is in beta with limited model availability. Supported models
are listed on the [pricing page](../pricing.md).
