---
source_url: https://developers.openai.com/api/docs/guides/external-models
fetched_at: 2026-07-27T01:55:40Z
---
...
- Your OpenAI organization must be in [usage tier 1](rate-limits/usage-tiers.md) or higher.
...
- An endpoint compatible with [OpenAI’s chat completions endpoint](../api-reference/chat/create.md)
- An API key
...
Uses Datasets to quickly build evals and iterate on prompts.](evaluation-getting-started.md)
[Working with evals
