---
source_url: https://developers.openai.com/api/docs/guides/priority-processing
...
- Per token costs are billed at a premium to standard - see [pricing](../pricing.md) for more information.
...
- See the [pricing page](../pricing.md) for which models currently support Priority processing.
