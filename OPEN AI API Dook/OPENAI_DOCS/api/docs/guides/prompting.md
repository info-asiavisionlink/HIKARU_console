...
fetched_at: 2026-07-27T01:56:19Z
---
...
- **[Prompt caching](prompt-caching.md)**: Reuse stable prompt prefixes to reduce latency and input token costs on cache hits
- **[Prompt engineering](prompt-engineering.md)**: Learn strategies, techniques, and tools to construct prompts
...
- Pass generated messages directly to the [Responses API](text.md) through `input` and `instructions`.
...
If you already use prompt IDs or prompt versions in API requests, follow the [migration guide](prompting/migrate-from-prompt-object.md) to move those prompts into code.
...
Learn how to prompt a model to generate text.](text.md)
[Engineer better prompts

Learn about OpenAI’s prompt engineering tools and techniques.](prompt-engineering.md)