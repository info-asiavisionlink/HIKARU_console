...
fetched_at: 2026-07-27T01:57:37Z
---
...
Refine each specialist’s instructions, tools, and output contract.](define-agents.md)[Running agents

Understand how handoffs and tools behave inside a run.](running-agents.md)[Results and state

See how

`lastAgent`

and resumable state affect the next turn.](results.md)