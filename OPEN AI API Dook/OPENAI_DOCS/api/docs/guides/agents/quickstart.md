...
Use the shared [Using tools](../tools.md) guide when you need hosted tools, tool search, or agents-as-tools.
...
Shape one specialist cleanly before you scale the workflow.](define-agents.md)[Using tools

Add hosted tools, function tools, and agents-as-tools.](../tools.md)[Running agents

Learn the agent loop, streaming, and continuation strategies.](running-agents.md)[Orchestration and handoffs

Decide when specialists should take over the conversation.](orchestration.md)