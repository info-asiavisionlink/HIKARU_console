...
fetched_at: 2026-07-27T01:57:36Z
---
...
![Diagram showing an agent harness running inside sandbox compute with filesystem access and gateway-mediated access to data, APIs, and the web.](../../../../assets/images_api_agents_harness_with_compute.png) ![Diagram showing an agent harness running inside sandbox compute with filesystem access and gateway-mediated access to data, APIs, and the web.](../../../../assets/images_api_agents_harness_with_compute.png) 
...
![Diagram showing an agent harness separate from sandbox compute, where the harness accesses trusted services and the sandbox executes commands against a filesystem.](../../../../assets/images_api_agents_harness_separate_from_compute.png) ![Diagram showing an agent harness separate from sandbox compute, where the harness accesses trusted services and the sandbox executes commands against a filesystem.](../../../../assets/images_api_agents_harness_separate_from_compute.png) 
...
call the [Responses API](/api/reference/responses/overview) directly or use the
...
[Using tools](../tools.md). Use sandbox
...
For complete local examples, see the TypeScript [sandbox agent quickstart](https://github.com/openai/openai-agents-js/blob/main/examples/docs/sandbox-agents/basic.ts) and Python [`unix_local_runner.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/unix_local_runner.py).
...
For runnable examples, see the TypeScript [sandbox clients guide](https://openai.github.io/openai-agents-js/guides/sandbox-agents/clients) and [basic example](https://github.com/openai/openai-agents-js/blob/main/examples/docs/sandbox-agents/basic.ts), plus Python [`basic.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/basic.py) for provider selection, [`docker_runner.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/docker/docker_runner.py) for Docker, and [`main.py`](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/dataroom_qa) for a data-room flow in the SDK repository.
...
| Example | Description |
| --- | --- |
| [Data room Q&A](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/dataroom_qa) | Answer questions over a mounted data room. |
| [Data room table extraction](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/dataroom_metric_extract) | Extract a table from a mounted data room. |
| [Repository code review](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/repo_code_review) | Clone a repo, inspect it, and produce code review artifacts. |
| [Vision website clone](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/vision_website_clone) | Clone a website using the Vision API and screenshot feedback. |
| [Sandbox resume](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/sandbox_resume) | Resume work in a pre-existing sandbox. |
...
in the TypeScript [resume session state example](https://github.com/openai/openai-agents-js/blob/main/examples/docs/sandbox-agents/resume-session-state.ts) and
Python [`main.py`](https://github.com/openai/openai-agents-python/tree/main/examples/sandbox/tutorials/sandbox_resume) and
[`sandbox_agent_with_remote_snapshot.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/sandbox_agent_with_remote_snapshot.py).
...
For runnable examples, see the TypeScript [memory guide](https://openai.github.io/openai-agents-js/guides/sandbox-agents/memory),
plus Python [`memory.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/memory.py) for a local snapshot flow,
[`memory_s3.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/memory_s3.py) for S3-backed memory storage, and
[`memory_multi_agent_multiturn.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/memory_multi_agent_multiturn.py) for separate
...
For examples, see [`handoffs.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/handoffs.py) and
[`sandbox_agents_as_tools.py`](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/sandbox_agents_as_tools.py).
...
| Cloudflare | `CloudflareSandboxClient` | [Sandbox documentation](https://developers.cloudflare.com/sandbox/) [OpenAI Agents tutorial](https://docs.cloudflare.com/sandbox/tutorials/openai-agents/) [Sandbox Bridge examples](https://github.com/cloudflare/sandbox-sdk/tree/main/bridge/examples) |
| Daytona | `DaytonaSandboxClient` | [Sandbox documentation](https://www.daytona.io/docs/en/sandboxes/) [OpenAI Agents SDK guide](https://www.daytona.io/docs/en/guides/openai-agents/openai-agents-sdk-with-sandboxes) |
| Docker | `DockerSandboxClient` | [Docker documentation](https://docs.docker.com/) [TypeScript Docker SDK example](https://github.com/openai/openai-agents-js/blob/main/examples/docs/sandbox-agents/docker-client.ts) [Python Docker SDK example](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/docker/docker_runner.py) |
| E2B | `E2BSandboxClient` | [Sandbox documentation](https://e2b.dev/docs) [OpenAI Agents SDK guide](https://e2b.dev/docs/agents/openai-agents-sdk) [Launch blog](https://e2b.dev/blog/e2b-is-now-in-agents-sdk) |
| Modal | `ModalSandboxClient` | [Sandbox guide](https://modal.com/docs/guide/sandboxes) [Integration blog](https://modal.com/blog/building-with-modal-and-the-openai-agent-sdk) [Example repo](https://github.com/modal-labs/openai-agents-python-example) [Modal extension reference](https://github.com/modal-labs/openai-agents-python-example?tab=readme-ov-file#modal-extension-reference) |
| Runloop | `RunloopSandboxClient` | [Devbox overview](https://docs.runloop.ai/docs/devboxes/overview) [Tunnels](https://docs.runloop.ai/docs/devboxes/tunnels) |
| Unix-local | `UnixLocalSandboxClient` | [TypeScript local SDK example](https://github.com/openai/openai-agents-js/blob/main/examples/docs/sandbox-agents/basic.ts) [Python local SDK example](https://github.com/openai/openai-agents-python/blob/main/examples/sandbox/unix_local_runner.py) |
| Vercel | `VercelSandboxClient` | [Sandbox documentation](https://vercel.com/docs/vercel-sandbox) [OpenAI Agents SDK guide](https://vercel.com/kb/guide/building-an-agent-with-openai-agents-sdk-and-vercel-sandbox) [FastAPI template](https://vercel.com/templates/template/openai-agents-sdk-with-fastapi) [Sample app](https://github.com/vercel-labs/openai-agents-fastapi-starter) |