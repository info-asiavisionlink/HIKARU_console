...
strategy.](running-agents.md)[Guardrails and human review

See how paused runs return interruptions and resumable state.](guardrails-approvals.md)[Integrations and observability

Use traces when you need to inspect the richer workflow record.](integrations-observability.md)