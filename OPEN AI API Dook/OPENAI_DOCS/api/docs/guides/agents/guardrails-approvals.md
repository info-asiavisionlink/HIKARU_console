...
fetched_at: 2026-07-27T01:57:38Z
---
...
See how interruptions and resumptions fit into the runtime loop.](running-agents.md)[Results and state

Learn which result surfaces paused runs return to your application.](results.md)[Using tools
