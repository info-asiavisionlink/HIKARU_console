...
fetched_at: 2026-07-27T01:56:26Z
---
...
[![Create images](../../../assets/API_docs_images_images.png)

Create images

Use GPT Image models to generate or edit images.](image-generation.md)[![Process image inputs](../../../assets/API_docs_images_vision.png)

Process image inputs

Use our models' vision capabilities to analyze images.](#analyze-images)
...
| --- | --- |
| [Responses API](../api-reference/responses.md) | Analyze images and use them as input and/or generate images as output |
| [Images API](../api-reference/images.md) | Generate images as output, optionally using images as input |
| [Chat Completions API](../api-reference/chat.md) | Analyze images and use them as input to generate text or audio |

To learn more about the input and output modalities supported by our models, refer to our [models page](../models.md).
...
generation](image-generation.md) guide.
...
For computer use, localization, and click-accuracy use cases on `gpt-5.4` and future models, we recommend `"detail": "original"`. See the [Computer use guide](tools-computer-use.md) for more detail.
...
The price depends on the dimensions of the image and the [input fidelity](image-generation.md).
...
To see pricing for image input tokens, refer to the [image pricing section](../pricing.md).
