---
source_url: https://developers.openai.com/api/docs/guides/cost-optimization
fetched_at: 2026-07-27T01:58:37Z
---
...
[Get started with the Batch API →](batch.md)
...
[Get started with flex processing →](flex-processing.md)