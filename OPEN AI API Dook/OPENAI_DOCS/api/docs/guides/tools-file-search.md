...
File search is a tool available in the [Responses API](../api-reference/responses.md).
...
You can filter the search results based on the metadata of the files. For more details, refer to our [retrieval guide](retrieval.md), which covers:

- How to [set attributes on vector store files](retrieval.md)
- How to [define filters](retrieval.md)
...
| --- | --- | --- |
| [Responses](../api-reference/responses.md)  [Chat Completions](../api-reference/chat.md)  [Assistants](../api-reference/assistants.md) | **Tier 1**  100 RPM  **Tier 2 and 3**  500 RPM  **Tier 4 and 5**  1000 RPM | [Pricing](../pricing.md)   [ZDR and data residency](your-data.md) |