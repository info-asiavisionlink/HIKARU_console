...
fetched_at: 2026-07-27T01:55:35Z
---
...
Explore all available nodes below. To learn more, read the [Agent Builder guide](agent-builder.md).

### Core nodes

Get started with basic building blocks. All workflows have start and agent nodes.

![core nodes](../../../assets/API_docs_images_core-nodes2.png)
...
![tool nodes](../../../assets/API_docs_images_tool-nodes2.png)
...
See the [file search documentation](tools-file-search.md) to set up vector stores and see supported file types.
...
Browse options in the Agent Builder. To learn more about MCP, see the [connectors and MCP documentation](tools-connectors-mcp.md).

### Logic nodes

![logic nodes](../../../assets/API_docs_images_logic-nodes.png)
...
![data nodes](../../../assets/API_docs_images_data-nodes.png)
