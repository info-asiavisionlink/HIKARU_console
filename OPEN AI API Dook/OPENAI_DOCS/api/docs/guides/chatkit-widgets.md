...
fetched_at: 2026-07-27T01:57:44Z
---
...
![widgets](../../../assets/API_images_widget-graphic.png)
...
Learn more in the [actions docs](chatkit-actions.md).
...
- **Box** – A flexible container for layout, supports direction, spacing, and styling.
  ...
  - `border`: int | `dict[str, Any]` | None
    (single border: `{ size: int, color?: str` | `{ dark: str, light: str }`, style?: “solid” | “dashed” | “dotted” | “double” | “groove” | “ridge” | “inset” | “outset” } `per-side`: `{ top?: int|dict, right?: int|dict, bottom?: int|dict, left?: int|dict, x?: int|dict, y?: int|dict }`)
