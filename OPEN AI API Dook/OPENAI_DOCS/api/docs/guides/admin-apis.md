---
source_url: https://developers.openai.com/api/docs/guides/admin-apis
fetched_at: 2026-07-27T01:58:55Z
---
...
For endpoint details, see the [Administration API reference](/api/reference/administration/overview), including [Admin API keys](/api/reference/resources/admin/subresources/organization/subresources/admin_api_keys), [Invites](/api/reference/resources/admin/subresources/organization/subresources/invites), [Users](/api/reference/resources/admin/subresources/organization/subresources/users), [Projects](/api/reference/resources/admin/subresources/organization/subresources/projects), [Spend limits](/api/reference/resources/admin/subresources/organization/subresources/spend_limit), and [Audit logs](/api/reference/resources/admin/subresources/organization/subresources/audit_logs).
...
Use the [Spend Limits endpoint](/api/reference/resources/admin/subresources/organization/subresources/spend_limit) to create or replace your organization’s monthly hard spend limit. Set `threshold_amount` in cents. The following example sets a $100 monthly limit:
...
When tracked spend reaches a hard limit, affected API requests return a `429` error. For details, see the [spend limits guide](spend-limits.md).
