...
fetched_at: 2026-07-27T01:55:07Z
---
...
The OpenAI API provides a consistent interface to state-of-the-art AI [models](models.md) for text generation, natural language processing, computer vision, and more. Get started by creating an API Key and running your first API call. Discover how to generate text, analyze images, build agents, and more.
...
securely [access the API](api-reference/authentication.md). Store the key
...
JavaScriptPython.NETJavaGoRuby
...
A simple API request to the [Responses API](api-reference/responses.md) would look like this:
...
A simple API request to [Responses API](api-reference/responses.md) would look like this:
...
A first API request to the [Responses API](api-reference/responses.md) would look like this:
...
Learn more about prompting, message roles, and building conversational apps.](guides/text.md)

## Add credits to keep building

[Go to billing](https://platform.openai.com/account/billing/overview)

Congrats on running a free test API request! Start building real applications with higher limits and use [our models](models.md) to generate text, audio, images, videos and more.
...
Use the Agents SDK to build, run, and observe agent workflows.](guides/agents.md)
...
Learn to use image inputs to the model and extract meaning from images.](guides/images.md)
[File inputs guide

Learn to use file inputs to the model and extract meaning from documents.](guides/file-inputs.md)

## Extend the model with tools

Give the model access to external data and functions by attaching [tools](guides/tools.md). Use built-in tools like web search or file search, or define your own for calling APIs, running code, or integrating with third-party systems.
...
Learn about powerful built-in tools like web search and file search.](guides/tools.md)
[Function calling guide

Learn to enable the model to call your own custom code.](guides/function-calling.md)

## Stream responses and build real-time apps

Use server‑sent [streaming events](guides/streaming-responses.md) to show results as they’re generated, or use the [Realtime API](guides/realtime.md) for interactive voice apps and apps with text, audio, and image inputs.
...
Use server-sent events to stream model responses to users fast.](guides/streaming-responses.md)
[Get started with the Realtime API

Use WebRTC or WebSockets for super fast speech-to-speech AI apps.](guides/realtime.md)

## Build agents

Use the OpenAI platform to build [agents](guides/agents.md) capable of taking action—like [controlling computers](guides/tools-computer-use.md)—on behalf of your users. Use the [Agents SDK](guides/agents.md) to create orchestration logic on your server.
...
Learn how to use the OpenAI platform to build powerful, capable AI agents.](guides/agents.md)