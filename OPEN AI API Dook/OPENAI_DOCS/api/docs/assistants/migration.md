...
fetched_at: 2026-07-27T01:55:55Z
---
...
We’re moving from the Assistants API to the new [Responses API](../guides/responses-vs-chat-completions.md) for a simpler and more flexible mental model.

Responses are simpler—send input items and get output items back. With the Responses API, you also get better performance and new features like [deep research](../guides/deep-research.md), [MCP](../guides/tools-remote-mcp.md), and [computer use](../guides/tools-computer-use.md). This change also lets you manage conversations instead of passing back `previous_response_id`.
...
1. Identify each existing Assistant’s *instruction + tool* bundle.
...
timeline](../deprecations.md) before adopting
