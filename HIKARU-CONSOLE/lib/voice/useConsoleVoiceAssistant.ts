...
function executeConsoleL2Navigation(
  ...
  switch (action) {
    ...
    case 'console.open_attendance_corrections':  router.push('/attendance/corrections'); return '勤怠修正申請一覧を開きます'
    ...
    case 'console.open_invoices_quotes':         router.push('/invoices/quotes');        return '見積書一覧を開きます'
    case 'console.open_invoices_bills':          router.push('/invoices/bills');         return '請求書一覧を開きます'
    ...
    case 'console.open_quality_surveys':         router.push('/quality/surveys');        return '顧客アンケートを開きます'
    case 'console.open_quality_workers':         router.push('/quality/workers');        return '作業者品質を開きます'
    ...
    case 'console.open_project_spot_list':       router.push('/projects/spot');          return 'スポット案件一覧を開きます'
    case 'console.open_project_recurring_list':  router.push('/projects/recurring');     return '定期案件一覧を開きます'
    case 'console.open_project_hotel_list':      router.push('/projects/hotel');         return 'ホテル案件一覧を開きます'
    default:
      return ''
  }
}
