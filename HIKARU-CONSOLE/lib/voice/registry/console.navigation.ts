...
export const CONSOLE_NAV_LABELS: Record<ConsoleNavDestination, string> = {
  dashboard:              'ダッシュボード',
  projects:               '案件管理',
  project_spot_list:      'スポット案件一覧',
  project_recurring_list: '定期案件一覧',
  project_hotel_list:     'ホテル案件一覧',
  ...
  shifts:                 'シフト管理',
  attendance:             '勤怠管理',
  attendance_corrections: '勤怠修正申請一覧',
  expenses:               '経費管理',
  invoices:               '請求管理',
  invoices_quotes:        '見積書一覧',
  invoices_bills:         '請求書一覧',
  notifications:          '通知',
  quality:                '品質管理',
  quality_surveys:        '顧客アンケート',
  quality_workers:        '作業者品質',
  manuals:                'マニュアル管理',
  reports:                '報告書',
  analytics:              'AI分析',
  inventory:              '在庫管理',
...
const CONSOLE_NAV_MAP: Record<ConsoleNavDestination, string> = {
  dashboard:              '/dashboard',
  projects:               '/projects',
  project_spot_list:      '/projects/spot',
  project_recurring_list: '/projects/recurring',
  project_hotel_list:     '/projects/hotel',
  ...
  quality:                '/quality',
  quality_surveys:        '/quality/surveys',
  quality_workers:        '/quality/workers',
  manuals:                '/manuals',
  reports:                '/reports',
  analytics:              '/analytics',
  inventory:              '/inventory',
