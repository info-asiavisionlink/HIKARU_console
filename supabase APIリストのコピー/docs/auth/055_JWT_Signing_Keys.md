---
タイトル: JWT Signing Keys
URL: https://supabase.com/docs/guides/auth/signing-keys
カテゴリ: auth
更新日: 2026-08-02
タグ: auth, keys, signing, signing-keys
---
...
- [Frequently asked questions#](#frequently-asked-questions)
  ...
  - [Why does revoking the legacy JWT secret require disabling ofanonandservice_roleAPI keys?#](#why-does-revoking-the-legacy-jwt-secret-require-disabling-of-anon-and-servicerole-api-keys)
  - [Using JWT-basedanonkey in a mobile, desktop, or CLI application and need to rotate aservice_roleJWT secret?#](#using-jwt-based-anon-key-in-a-mobile-desktop-or-cli-application-and-need-to-rotate-a-servicerole-jwt-secret)
  - [Why areanonandservice_roleJWT-based keys no longer recommended?#](#why-are-anon-and-servicerole-jwt-based-keys-no-longer-recommended)
  - [Can you still use an oldanonandservice-roleAPI keys after enabling the publishable and secret keys?#](#can-you-still-use-an-old-anon-and-service-role-api-keys-after-enabling-the-publishable-and-secret-keys)
  - [How to deactivate theanonandservice_roleJWT-based API keys after moving to publishable and secret keys?#](#how-to-deactivate-the-anon-and-servicerole-jwt-based-api-keys-after-moving-to-publishable-and-secret-keys)
