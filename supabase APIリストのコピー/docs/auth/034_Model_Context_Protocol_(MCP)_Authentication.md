---
タイトル: Model Context Protocol (MCP) Authentication
URL: https://supabase.com/docs/guides/auth/oauth-server/mcp-authentication
カテゴリ: auth
更新日: 2026-08-02
タグ: auth, authentication, context, mcp-authentication, model, oauth-server, protocol
---
...
Integrate Supabase Auth with MCP servers to authenticate AI agents using your existing user base
