---
タイトル: OAuth 2.1 Server
URL: https://supabase.com/docs/guides/auth/oauth-server
カテゴリ: auth
更新日: 2026-08-02
タグ: auth, oauth, oauth-server, server
---
...
Turn your Supabase project into an OAuth 2.1 and OpenID Connect identity provider
...
[Getting StartedEnable OAuth 2.1, configure your authorization endpoint, and register your first client.](</docs/guides/auth/oauth-server/getting-started>)

[OAuth FlowsDetailed walkthrough of authorization code and refresh token flows.](</docs/guides/auth/oauth-server/oauth-flows>)

[MCP AuthenticationAuthenticate AI agents and LLM tools using Model Context Protocol.](</docs/guides/auth/oauth-server/mcp-authentication>)

[Token Security & RLSControl data access with Row Level Security policies for OAuth clients.](</docs/guides/auth/oauth-server/token-security>)
