...
カテゴリ: auth
更新日: 2026-08-02
タグ: advanced, advanced-guide, auth, guide, server-side
---
...
- [Frequently asked questions#](#frequently-asked-questions)
  ...
  - [How do I make the cookiesHttpOnly?#](#how-do-i-make-the-cookies-httponly-)
  ...
  - [Should I set a shorterMax-Ageparameter on the cookies?#](#should-i-set-a-shorter-max-age-parameter-on-the-cookies)
  - [What should I use for theSameSiteproperty?#](#what-should-i-use-for-the-samesite-property)
