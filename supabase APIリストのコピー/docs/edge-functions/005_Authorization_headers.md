---
タイトル: Authorization headers
URL: https://supabase.com/docs/guides/functions/auth-headers
カテゴリ: edge-functions
更新日: 2026-08-02
タグ: auth, auth-headers, authorization, edge-functions, functions, headers
---
...
- [Understanding authorization headers#](#understanding-authorization-headers)
- [Theverify_jwtplatform check#](#the-verifyjwt-platform-check)

## 概要

How the Authorization and apikey request headers and the verify_jwt platform check work for Edge Functions.
