---
タイトル: Local development workflow
URL: https://supabase.com/docs/guides/local-development/cli-workflows
カテゴリ: cli
更新日: 2026-08-02
タグ: cli, cli-workflows, development, local, local-development, workflow
---
...
- [The./supabasedirectory#](#the-supabase-directory)
- [Move an existing project to local development#](#move-an-existing-project-to-local-development)
  ...
  - [Step 3: Link to your remote project#](#step-3-link-to-your-remote-project)
  - [Step 4: Pull the remote schema#](#step-4-pull-the-remote-schema)
  - [Step 5: Create seed data#](#step-5-create-seed-data)
  - [Step 6: Verify#](#step-6-verify)
  - [Step 7: Commit#](#step-7-commit)
- [Start a new project from scratch#](#start-a-new-project-from-scratch)
  - [Step 1: Initialize#](#step-1-initialize)
  - [Step 2: Start the local stack#](#step-2-start-the-local-stack)
  - [Step 3: Create your schema#](#step-3-create-your-schema)
  - [Step 4: Add seed data#](#step-4-add-seed-data)
  - [Step 5: Verify#](#step-5-verify)
  - [Step 6: Commit#](#step-6-commit)
- [The daily workflow#](#the-daily-workflow)
  - [Making schema changes#](#making-schema-changes)
  - [Generating types#](#generating-types)
  - [Staying in sync with your team#](#staying-in-sync-with-your-team)
- [Pushing to a remote project#](#pushing-to-a-remote-project)
  - [Resetting a remote dev or staging project#](#resetting-a-remote-dev-or-staging-project)
- [Key commands at a glance#](#key-commands-at-a-glance)
- [Cleaning up generated migrations#](#cleaning-up-generated-migrations)
...
There are two starting points, both leading to the same place: database schema and migrations tracked in version control, with seed data for local development.
  ...
  * **Move an existing project to local development** : you have a project on the Supabase platform and want to bring it into a proper local development workflow.
  * **Start a new project from scratch** : you're building locally and will eventually push to a remote instance.
...
Declarative schemasImperative migrations
  ...
  3. Review the generated migration file. See Cleaning up generated migrations
