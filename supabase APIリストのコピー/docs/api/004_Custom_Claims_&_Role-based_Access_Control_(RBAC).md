---
タイトル: Custom Claims & Role-based Access Control (RBAC)
URL: https://supabase.com/docs/guides/api/custom-claims-and-role-based-access-control-rbac
カテゴリ: api
更新日: 2026-08-02
タグ: access, ai, api, based, claims, control, custom, custom-claims-and-role-based-access-control-rbac, rbac, role
---
