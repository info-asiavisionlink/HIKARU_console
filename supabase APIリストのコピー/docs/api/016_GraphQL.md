...
- [Clients#](#clients)
  ...
  - [GraphiQL#](#graphiql)
- [Schema & Table Visibility#](#schema--table-visibility)
  - [Remove a Table from the API#](#remove-a-table-from-the-api)
  - [Add a Schema to the API#](#add-a-schema-to-the-api)
- [Version Management#](#version-management)
- [Local Development#](#local-development)
- [Term Reference#](#term-reference)
  - [Project Reference (PROJECT_REF)#](#project-reference-projectref)
