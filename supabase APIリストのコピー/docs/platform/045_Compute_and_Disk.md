---
タイトル: Compute and Disk
URL: https://supabase.com/docs/guides/platform/compute-and-disk
カテゴリ: platform
更新日: 2026-08-02
タグ: compute, compute-and-disk, disk, platform
---
...
Learn about your project's compute and disk sizing options.
...
![Compute Size Selection](/docs/_next/image?url=%2Fdocs%2Fimg%2Fguides%2Fplatform%2Fcompute-size-selection--light.png&w=3840&q=75)
...
## Footnotes#
  ...
  3. Database max connections are recommended values and can be [customized via `max_connections`](</docs/guides/database/custom-postgres-config>) depending on your use case. Be aware of [these considerations](</docs/guides/troubleshooting/how-to-change-max-database-connections-_BQ8P5>) before modifying. ↩