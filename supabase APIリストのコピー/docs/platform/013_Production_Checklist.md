---
タイトル: Production Checklist
URL: https://supabase.com/docs/guides/deployment/going-into-prod
カテゴリ: platform
更新日: 2026-08-02
タグ: checklist, deployment, going-into-prod, platform, production
---
...
---|---|---|---  
All endpoints that send emails| `/auth/v1/signup` `/auth/v1/recover` `/auth/v1/user`[^1]| Sum of combined requests| As of 3 Sep 2024, this has been updated to 2 emails per hour. You can only change this with your own [custom SMTP setup](</docs/guides/auth/auth-smtp>).  
