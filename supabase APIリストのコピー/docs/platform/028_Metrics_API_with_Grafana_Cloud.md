---
タイトル: Metrics API with Grafana Cloud
URL: https://supabase.com/docs/guides/monitoring-and-debugging/metrics/grafana-cloud
カテゴリ: platform
更新日: 2026-08-02
タグ: api, cloud, grafana, grafana-cloud, metrics, monitoring-and-debugging, platform, with
---
...
- [Manual setup#](#manual-setup)
  ...
  - [1. Create a Grafana Cloud stack#](#1-create-a-grafana-cloud-stack)
  - [2. Install the Supabase integration for Grafana Cloud#](#2-install-the-supabase-integration-for-grafana-cloud)
  - [3. Configure the Supabase integration#](#3-configure-the-supabase-integration)
  - [4. Import the Supabase dashboard#](#4-import-the-supabase-dashboard)
  - [5. Configure alerts (optional)#](#5-configure-alerts-optional)
  - [6. Troubleshooting#](#6-troubleshooting)

## 概要

Use Grafana Cloud’s managed Prometheus to visualize Supabase metrics
