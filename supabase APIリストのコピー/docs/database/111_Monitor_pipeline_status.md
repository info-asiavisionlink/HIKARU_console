---
タイトル: Monitor pipeline status
URL: https://supabase.com/docs/guides/database/replication/pipelines-monitoring
カテゴリ: database
更新日: 2026-08-02
タグ: database, monitor, pipeline, pipelines-monitoring, replication, status
---
...
- [Viewing detailed pipeline metrics#](#viewing-detailed-pipeline-metrics)
  ...
  - [Slot statuses#](#slot-statuses)
  - [Table states#](#table-states)
- [Dealing with replication lag#](#dealing-with-replication-lag)
  - [Initial sync and table-sync slots#](#initial-sync-and-table-sync-slots)
  - [Investigate the lag#](#investigate-the-lag)
  - [Respond based on the slot status#](#respond-based-on-the-slot-status)
  - [Reduce future lag risk#](#reduce-future-lag-risk)
...
Monitor the status and health of pipelines created with Supabase Pipelines.
...
![Running pipeline status page showing replication metrics and a live table](/docs/_next/image?url=%2Fdocs%2Fimg%2Fdatabase%2Freplication%2Fpipelines-metrics.png&w=3840&q=75)Use the pipeline status page to check replication lag, WAL retention remaining, connection health, and table states.
