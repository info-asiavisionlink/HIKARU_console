---
タイトル: Securing your data
URL: https://supabase.com/docs/guides/database/secure-data
カテゴリ: database
更新日: 2026-08-02
タグ: data, database, secure-data, securing, your
---
...
- [Connecting your app securely#](#connecting-your-app-securely)
  ...
  - [Direct database connections#](#direct-database-connections)
...
Never expose your service role or secret keys on the frontend
