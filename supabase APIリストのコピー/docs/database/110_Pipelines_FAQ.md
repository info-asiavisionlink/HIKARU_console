...
カテゴリ: database
更新日: 2026-08-02
タグ: database, pipelines, pipelines-faq, replication
---
...
- [Does the destination's region affect performance?#](#does-the-destinations-region-affect-performance)
- [Which plans support Pipelines?#](#which-plans-support-pipelines)
- [What happened to Analytics Buckets replication?#](#what-happened-to-analytics-buckets-replication)
- [What does Pipelines install in the database?#](#what-does-pipelines-install-in-the-database)
- [What schema changes are supported?#](#what-schema-changes-are-supported)
- [What happens when you disable Pipelines?#](#what-happens-when-you-disable-pipelines)
- [Why is a table not being replicated?#](#why-is-a-table-not-being-replicated)
- [Why are partitioned tables replicated as separate tables?#](#why-are-partitioned-tables-replicated-as-separate-tables)
- [How does replica identity affect updates and deletes?#](#how-does-replica-identity-affect-updates-and-deletes)
...
- [Why was the pipeline stopped?#](#why-was-the-pipeline-stopped)
- [Why is replication lag increasing?#](#why-is-replication-lag-increasing)
- [What does aLostslot status mean?#](#what-does-a-lost-slot-status-mean)
...
- [How to stop replication#](#how-to-stop-replication)
- [What happens if a project becomes inactive?#](#what-happens-if-a-project-becomes-inactive)
- [What happens after a downgrade to the free plan?#](#what-happens-after-a-downgrade-to-the-free-plan)
- [What happens if a table is deleted at the destination?#](#what-happens-if-a-table-is-deleted-at-the-destination)
- [Can data be processed more than once?#](#can-data-be-processed-more-than-once)
- [Where to find replication logs#](#where-to-find-replication-logs)
- [How to get help#](#how-to-get-help)

## 概要

Frequently asked questions about Supabase Pipelines.
