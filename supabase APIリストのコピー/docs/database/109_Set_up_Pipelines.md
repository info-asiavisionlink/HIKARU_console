...
- [Setup overview#](#setup-overview)
  ...
  - [Step 2: Enable Pipelines#](#step-2-enable-pipelines)
  - [Step 3: Configure a destination#](#step-3-configure-a-destination)
  - [Step 4: Monitor your pipeline#](#step-4-monitor-your-pipeline)
  - [Managing your pipeline#](#managing-your-pipeline)
  - [Disabling Pipelines#](#disabling-pipelines)
  - [Adding or removing tables#](#adding-or-removing-tables)
  - [Schema change support#](#schema-change-support)
...
Create a Supabase Pipeline using Postgres logical replication.
...
![Pipeline cost confirmation showing the initial sync estimate and ongoing replication prices](/docs/_next/image?url=%2Fdocs%2Fimg%2Fdatabase%2Freplication%2Fpipelines-cost-confirmation.png&w=3840&q=75)Review the estimated initial sync cost and the separate ongoing charges before creating the pipeline.
...
![Destinations list with the actions menu open for a running BigQuery pipeline](/docs/_next/image?url=%2Fdocs%2Fimg%2Fdatabase%2Freplication%2Fpipelines-actions-menu.png&w=3840&q=75)Use the actions menu to update, restart, stop, edit, or delete a pipeline destination.
