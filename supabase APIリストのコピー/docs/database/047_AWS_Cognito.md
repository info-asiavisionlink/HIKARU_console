...
カテゴリ: database
更新日: 2026-08-02
タグ: cognito, database, extensions, wrappers
---
...
- [Preparation#](#preparation)
  ...
  - [Enable the Cognito Wrapper#](#enable-the-cognito-wrapper)
  - [Store your credentials (optional)#](#store-your-credentials-optional)
  - [Connecting to Cognito#](#connecting-to-cognito)
...
[Open wrapper in dashboard](<https://supabase.com/dashboard/project/_/integrations/cognito_wrapper/overview>)
