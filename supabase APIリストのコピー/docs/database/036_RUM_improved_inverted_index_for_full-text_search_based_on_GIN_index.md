---
タイトル: RUM: improved inverted index for full-text search based on GIN index
URL: https://supabase.com/docs/guides/database/extensions/rum
カテゴリ: database
更新日: 2026-08-02
タグ: based, database, extensions, full, improved, index, inverted, rum, search, text
---
...
A GIN-like index with additional tree-organized data for each index entry
