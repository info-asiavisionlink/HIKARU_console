...
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, hnsw, hnsw-indexes, indexes, vector, vector-indexes
---
...
- [Filtering with HNSW indexes#](#filtering-with-hnsw-indexes)
- [Resources#](#resources)

## 概要

Understanding HNSW indexes in pgvector
...
![Diagram of a multi-layer skip list: the bottom layer is a linked list of all ordered elements, and each higher layer keeps a sparser subset that skips over elements.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fvector-indexes%2Fhnsw-indexes%2Fskip-list--light.png&w=3840&q=75)
...
![Diagram of a navigable small world graph, where each node connects to nearby neighbors plus a few long-range links that let almost any node reach any other within a few hops.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fvector-indexes%2Fhnsw-indexes%2Fnsw.png&w=2048&q=75)
