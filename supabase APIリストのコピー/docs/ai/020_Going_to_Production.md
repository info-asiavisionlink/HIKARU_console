---
タイトル: Going to Production
URL: https://supabase.com/docs/guides/ai/going-to-prod
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, going, going-to-prod, production
---
...
- [HNSW, understandingef_construction,ef_search, andm#](#hnsw-understanding-efconstruction--efsearch--and-)
- [IVFFlat, understandingprobesandlists#](#ivfflat-understanding-probes-and-lists)
...
Checklist for going to production with your AI application.
...
![dbpedia embeddings comparing ivfflat and hnsw queries-per-second using the 4XL compute add-on](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fgoing-prod%2Fdbpedia-ivfflat-vs-hnsw-4xl--light.png&w=3840&q=75)
...
![dbpedia embeddings comparing hnsw queries-per-second using different build parameters](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fgoing-prod%2Fdbpedia-hnsw-build-parameters--light.png&w=3840&q=75)
...
You can find more examples of how `lists` and `probes` constants affect accuracy and QPS in [pgvector 0.4.0 performance](</blog/pgvector-performance>) blog post.

The chart below shows how the IVFFlat lists count affects accuracy and queries-per-second.

![Chart showing how the IVFFlat lists count affects query accuracy and queries-per-second.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fgoing-prod%2Flists-count--light.png&w=3840&q=75)
...
![Chart plotting requests-per-second against Supabase compute size.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fgoing-prod%2Fsize-to-rps--light.png&w=3840&q=75)