---
タイトル: Choosing your Compute Add-on
URL: https://supabase.com/docs/guides/ai/choosing-compute-addon
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, choosing, choosing-compute-addon, compute, your
---
...
![Chart comparing HNSW queries-per-second across Supabase compute sizes for different embedding dimensions.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Finstance-type%2Fhnsw-dims--light.png&w=3840&q=75)
...
![Chart showing how HNSW build parameters \(m and ef_construction\) affect requests-per-second on the dbpedia dataset.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Fgoing-prod%2Fdbpedia-hnsw-build-parameters--light.png&w=3840&q=75)
...
![Diagram of the vecs benchmark setup: a Python test runner uploads data, builds the index, and runs queries against pgvector.](/docs/_next/image?url=%2Fdocs%2Fimg%2Fai%2Finstance-type%2Fvecs-benchmark--light.png&w=3840&q=75)
