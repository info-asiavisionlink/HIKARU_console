...
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, search, semantic, semantic-search
---
...
- [Semantic search in Postgres#](#semantic-search-in-postgres)
  ...
  - [Filtering vector search by metadata#](#filtering-vector-search-by-metadata)
...
`pgvector` supports 3 operators for computing distance between embeddings:
