---
タイトル: IVFFlat indexes
URL: https://supabase.com/docs/guides/ai/vector-indexes/ivf-indexes
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, indexes, ivf-indexes, ivfflat, vector, vector-indexes
---
...
- [Usage#](#usage)
  - [Euclidean L2 distance (vector_l2_ops)#](#euclidean-l2-distance---)
...
Understanding IVFFlat indexes in pgvector
