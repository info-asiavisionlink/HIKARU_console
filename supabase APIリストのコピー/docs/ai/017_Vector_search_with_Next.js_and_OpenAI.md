---
タイトル: Vector search with Next.js and OpenAI
URL: https://supabase.com/docs/guides/ai/examples/nextjs-vector-search
カテゴリ: ai
更新日: 2026-08-02
タグ: ai, examples, next, nextjs, nextjs-vector-search, openai, search, vector, with
---
...
Prepare the database schema. We can use the "OpenAI Vector Search" quickstart in the [SQL Editor](</dashboard/project/_/sql>), or you can copy/paste the SQL below and run it yourself.
